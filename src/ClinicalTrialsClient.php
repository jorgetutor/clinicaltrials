...
namespace Tutor\ClinicalTrials;
...
/**
 * A ClinicalTrialsClient
 */
class ClinicalTrialsClient extends GuzzleClient
{
    /**
     * Factory method to create a new ClinicalTrialsClient
     *
